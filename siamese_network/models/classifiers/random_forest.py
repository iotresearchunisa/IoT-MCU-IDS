...
# ==========================================================
#  Main function to train and evaluate Random Forest with K-Fold
# ==========================================================
def train_random_forest(csv_file, k_folds):
    ...
    for train_index, val_index in kf.split(X_train):
        ...
        rf_classifier.fit(X_k_train, y_k_train)

        # Evaluate on the validation set
        y_val_pred = rf_classifier.predict(X_k_val)
...
if __name__ == "__main__":
    ...
    train_random_forest(csv_file, k_folds)