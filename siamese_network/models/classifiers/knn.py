...
from models.classifiers.utils.preprocessing import *


# ==========================================================
#  Main function to train and evaluate KNN with K-Fold
# ==========================================================
def train_knn(csv_file, k_folds):
    # PRE-PROCESSING
    ...
    for train_index, val_index in kf.split(X_train):
        ...
        knn_classifier.fit(X_k_train, y_k_train)

        # Evaluate on the validation set
        y_val_pred = knn_classifier.predict(X_k_val)
