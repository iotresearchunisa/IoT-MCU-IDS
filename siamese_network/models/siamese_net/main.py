...
from utils.generate_pairs import *
from utils.preprocessing import *
from utils.siamese_net import SiameseNet
import pandas as pd
from utils.save_components import *
...
def train_siamese_network(csv_file, path_results, train, num_pairs, convert_model, save_pairs):
    if train:
        ...
        if save_pairs:
            ...
            save_pairs_to_header(test_a, test_b, test_labels, result_path + 'test_pairs.h')
...
if __name__ == "__main__":
    csv_file = '../../datasets/Few-Shot_IoT/dataset_attacchi_con_MQTT_bilanciato.csv'
    result_path = "../../results/Few-Shot_IoT/snn/07/"
