...
# ==========================================================
def train_random_forest(csv_file, model_filename, train):
    if train:
        ...
        with open(model_filename, 'wb') as file:
            pickle.dump((rf_classifier, scaler, label_encoder), file)
        ...
        with open(model_filename, 'rb') as file:
            rf_classifier, scaler, label_encoder = pickle.load(file)
...
if __name__ == "__main__":
    ...
    model_filename = 'results/train_reduced/mio/con_mqtt/_20/random_forest/random_forest.pkl'
    train = True

    train_random_forest(csv_file, model_filename, train)
